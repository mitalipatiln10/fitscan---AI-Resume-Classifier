...
# Only the tokenizer + vocab are needed for PhraseMatcher -- disabling the
# rest (parser, NER, lemmatizer, tagger) cuts memory noticeably, which
# matters on memory-constrained hosting tiers.
_nlp = spacy.load("en_core_web_sm", disable=["parser", "ner", "lemmatizer", "tagger", "attribute_ruler"])
