...
Set your API key as an environment variable before running the server:
    setx GEMINI_API_KEY "AQ.Ab8RN6LzyJvt2Gq6VMNb3wm8MBZwGHcsfxCKpEvzN9QuEdCLSg"         (Windows, permanent — reopen terminal after)
    $env:GEMINI_API_KEY = "AQ.Ab8RN6LzyJvt2Gq6VMNb3wm8MBZwGHcsfxCKpEvzN9QuEdCLSg"       (Windows, current session only)
    export GEMINI_API_KEY=AQ.Ab8RN6LzyJvt2Gq6VMNb3wm8MBZwGHcsfxCKpEvzN9QuEdCLSg         (Mac/Linux)
...
MODEL = "gemini-3.6-flash" # free tier, ~15 RPM / ~250 RPD as of 2026
